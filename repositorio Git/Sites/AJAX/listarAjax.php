                ...
                <div class="modal-content rounded-4 shadow">
                    ...
                    <!--forms-->
                        <form method="post" action="">
                            ...
                            <button type="submit" class="botao" name="acao" value="Enviar">Enviar</button>
                    ...
                    xhr.onload = function() {
                        if (this.status === 200) {
                            ...
                            if (response.status === 'success') {
                                ...
                                buscarUsuarios(); // Atualiza a lista de produtos
                            } else {
                                alert(response.message);
                            }
                        }
            ...
            if ($acao == "Enviar") {
                ...
                elseif ($acao == "Consultar") {
                    ...
                    if ($resultado->num_rows > 0) {
                        ...
                        echo '<center><table class="table table-striped table-bordered mt-3">';
                        echo "<tr>
                                <th>ID</th>
                                <th>Nome do Produto</th>
                                <th>Marca</th>
